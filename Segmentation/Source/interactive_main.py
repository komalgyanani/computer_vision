...
BLUE = [255, 0, 0]  # BG color
RED = [0, 0, 255]  # FG color
...
#mouse handling event for left click press, mouse drag and mouse release
def onmouse(event, x, y, flags, param):
    global img, img2, drawing, value, mask
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        ...
        print("Correct Usage: python main_bonus.py <filename> \n")
    ...
    cv2.moveWindow('input', img.shape[1] + 90, 90)
